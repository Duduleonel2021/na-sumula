...
<span class="mdc-section-kicker"><?php echo esc_html('ESTRUTURA'); ?></span>
        <h1><?php echo esc_html('Confederações'); ?></h1>
        <p><?php echo esc_html('As organizações continentais que formam o mapa do futebol mundial.'); ?></p>
